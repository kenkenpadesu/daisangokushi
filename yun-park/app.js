/* ゆんぱーく 武勲記録 — 動作ロジック。データは data.js (window.DATA) から読む。 */
(function () {
  'use strict';
  ...
  const SQCOL = { '成龍': '#d6b25c', '八宝菜': '#79c39a', '奇兵隊': '#dd6e5a', '剣ぱ': '#7aa2d6', '煽り紳士': '#c58fd0', '浪子': '#e0a45c', 'べぽ': '#6fc3c0' };
  ...
  function initGraphs() {
    ...
    sel.value = mnames.includes('剣権羽 kenkenpa') ? '剣権羽 kenkenpa' : mnames[0];
    drawMember();
